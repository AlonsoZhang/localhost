...
if(isset($_REQUEST["FileName"]))
{
   ...
   $Stations      = "MPC,LASER ETCH (OMS),MBT -  Pre Line,RSW,RCW,IT-RS1,IT-RS2,MBA,MBO,PFR,SA-IT-CG,LFW,RFW,CIM,Mic2,DP,SMS,SA-IT-HSG1,SA-IT-HSG2,RCAM Install,Battery 3-in-1 POR,CDP,HDP,AAA,CGS,STOM,IT-CG,IT4,IT-HSG1,IT-HSG2,LASER ETCH";
   ...
   //N71
   $NameMatch['MBT -  Pre Line']       = 'TestSpec_MBT';
   $NameMatch['LASER ETCH (OMS)']      = 'TestSpec_LASER-ETCH';
   $NameMatch['MPC']      = 'TestSpec_MPC';
